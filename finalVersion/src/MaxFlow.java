...
class MaxFlow {
    ...
    int fordFulkerson(int graph[][], int s, int t, JTextField jfield, List<String> verticesNames, String frameTitle, String[] inputGraphEdges,ArrayList <JPanel> panels) {
        int u, v;
