...
public class Dijkstra {
    ...
    int getEdgeName(String[] edges, String vertex1, String vertex2, String frameTitle) {
        ...
        for (int i = 0; i < edges.length; i += 2) {
            ...
            if ((frameTitle.equals("directed") && edges[i].equals(vertex1) && edges[i + 1].equals(vertex2))
                    || (frameTitle.equals("undirected") && ((edges[i].equals(vertex1) && edges[i + 1].equals(vertex2))
    ...
    int[] dijkstra(int representative[][], int src, int V, List<String> NameOfVertices,
        String frameTitle2, String[] Edges, ArrayList <JPanel> panels ) {
        int edgeIndex;
        ...
        for (int count = 0; count < V; count++) {
            ...
            if (frameTitle2.equals("directed")) {
                g = new directedGraph();
            } else {
